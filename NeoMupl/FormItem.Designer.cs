namespace NeoMupl
{
    partial class FormItem
    {
        ...
        private void InitializeComponent()
        {
			...
			this.nudLoopAroundSeconds = new System.Windows.Forms.NumericUpDown();
			this.panel1.SuspendLayout();
			this.tableLayoutPanel1.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.trbSkipRate)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.trbVolume)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.nudLoopAroundSeconds)).BeginInit();
			this.SuspendLayout();
			// 
			// btnOK
			// 
			...
			this.tableLayoutPanel1.Controls.Add(this.nudLoopAroundSeconds, 4, 9);
			...
			// 
			// nudLoopAroundSeconds
			// 
			this.nudLoopAroundSeconds.Dock = System.Windows.Forms.DockStyle.Fill;
			this.nudLoopAroundSeconds.Location = new System.Drawing.Point(491, 225);
			this.nudLoopAroundSeconds.Margin = new System.Windows.Forms.Padding(0);
			this.nudLoopAroundSeconds.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
			this.nudLoopAroundSeconds.Name = "nudLoopAroundSeconds";
			this.nudLoopAroundSeconds.Size = new System.Drawing.Size(52, 19);
			this.nudLoopAroundSeconds.TabIndex = 27;
			this.nudLoopAroundSeconds.Value = new decimal(new int[] {
            5,
            0,
            0,
            0});
			this.nudLoopAroundSeconds.ValueChanged += new System.EventHandler(this.nudLoopAroundSeconds_ValueChanged);
			// 
			// FormItem
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.nudLoopAroundSeconds)).EndInit();
        ...
        private System.Windows.Forms.NumericUpDown nudLoopAroundSeconds;
    }
}
